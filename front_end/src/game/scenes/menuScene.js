...
var MenuLayer = cc.Layer.extend({
    ...
    init:function(){
        ...
        var playItem = cc.MenuItemLabel.create(cc.LabelTTF.create("Play", "Arial", 30), function(){

            socketClient.init();
            //console.log(socketClient.currentState);

            //if (socketClient.currentState === "readyToPlay"){
            //    cc.Director.getInstance().replaceScene(cc.TransitionFade.create(3,new GameScene()));
            //}else{
                cc.Director.getInstance().replaceScene(cc.TransitionFade.create(0,new WaitingPlayerScene()));
            //}
